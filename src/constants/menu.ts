...
export const MENU_ITEMS: MenuItem[] = [
  // TEA CATEGORY - Directed to TEA-MAKER (Chef A)
  {
    ...
    basePrice: 50,
    chef: 'chef_a',
    variants: [{ id: 'bt_normal', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_coffee',
    name: 'Black Coffee',
    ...
    basePrice: 60,
    chef: 'chef_a',
    variants: [{ id: 'bc_standard', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_mint',
    name: 'Mint Tea',
    ...
    basePrice: 60,
    chef: 'chef_a',
    variants: [{ id: 'bt_mint', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_cardamom',
    name: 'Cardamom Black Tea',
    category: 'tea',
    basePrice: 65,
    chef: 'chef_a',
    variants: [{ id: 'bt_cardamom', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_ginger',
    ...
    basePrice: 65,
    chef: 'chef_a',
    variants: [{ id: 'bt_ginger', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_jaggery',
    name: 'Jaggery Black Tea',
    category: 'tea',
    basePrice: 70,
    chef: 'chef_a',
    variants: [{ id: 'bt_jaggery', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_cinnamon',
    name: 'Cinnamon Black Tea',
    category: 'tea',
    basePrice: 70,
    chef: 'chef_a',
    variants: [{ id: 'bt_cinnamon', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_masala',
    ...
    basePrice: 70,
    chef: 'chef_a',
    variants: [{ id: 'bt_masala', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_grape',
    name: 'Grape Tea',
    ...
    basePrice: 75,
    chef: 'chef_a',
    variants: [{ id: 'bt_grape', name: 'Standard', priceModifier: 0 }],
  },
  {
    id: 'black_tea_blackcurrant_bag',
    name: 'Black Currant Tea',
    category: 'tea',
    basePrice: 80,
    chef: 'chef_a',
    variants: [{ id: 'bt_blackcurrant_bag', name: 'Tea Bag', priceModifier: 0 }],
  },
  {
    id: 'black_tea_raspberry_bag',
    name: 'Raspberry Tea',
    category: 'tea',
    basePrice: 80,
    chef: 'chef_a',
    variants: [{ id: 'bt_raspberry_bag', name: 'Tea Bag', priceModifier: 0 }],
  },
  {
    id: 'black_tea_strawberry_bag',
    name: 'Strawberry Tea',
    category: 'tea',
    basePrice: 80,
    chef: 'chef_a',
    variants: [{ id: 'bt_strawberry_bag', name: 'Tea Bag', priceModifier: 0 }],
  },
  {
    id: 'black_tea_peach_bag',
    name: 'Peach Tea',
    category: 'tea',
    basePrice: 80,
    chef: 'chef_a',
    variants: [{ id: 'bt_peach_bag', name: 'Tea Bag', priceModifier: 0 }],
  },
  {
    id: 'milk_tea',
    name: 'Milk Tea',
